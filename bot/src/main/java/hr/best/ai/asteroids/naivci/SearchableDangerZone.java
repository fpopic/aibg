    ...
    public Position getClosestSafe(double xPos, double yPos, double i, double j) {
        ...
        while (step < 30) {
            ...
            if (x1 > margin && x1 < width - margin && y1 > margin && y1 < height - margin &&
                ...
                int softpenalty = 0;
//                if (x1 > softMargin && x1 < width - softMargin && y1 > softMargin && y1 < height - softMargin)
//                    softpenalty = 10;
            ...
            if (x2 > margin && x2 < width - margin && y2 > margin && y2 < height - margin &&
                ...
                int softpenalty = 0;
//                if (x2 > softMargin && x2 < width - softMargin && y2 > softMargin && y2 < height - softMargin)
//                    softpenalty = 10;
            ...
            if (x3 > margin && x3 < width - margin && y3 > margin && y3 < height - margin &&
                ...
                int softpenalty = 0;
//                if (x3 > softMargin && x3 < width - softMargin && y3 > softMargin && y3 < height - softMargin)
//                    softpenalty = 10;
            ...
            if (x4 > margin && x4 < width - margin && y4 > margin && y4 < height - margin &&
                ...
                int softpenalty = 0;
//                if (x4 > softMargin && x4 < width - softMargin && y4 > softMargin && y4 < height - softMargin)
//                    softpenalty = 10;
